...
Future<BitmapDescriptor> getEndCustomMarker(int kilometres, String destination ) async {
  
  final recorder = ui.PictureRecorder();
  final canvas = ui.Canvas(recorder);
  const size = ui.Size(350,150);

  final startMarker = EndMarkerPainter(kilometres: kilometres, destination: destination);
startMarker.paint(canvas, size);
