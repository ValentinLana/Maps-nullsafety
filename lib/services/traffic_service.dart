...
import 'package:maps/services/places_interceptor.dart';
import 'package:maps/services/traffic_interceptor.dart';
...
//construye y añade el interceptor (contiene los query params)
  ...
  Future<Feature> getInformationByCoors(LatLng coors) async {
        ...
        //sobreescribimos el queryParameters para que solo traiga un resultado
        final resp = await _dioPlaces.get(url, queryParameters: {
          'limit': 1
        });
